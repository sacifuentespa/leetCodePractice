...
var cancellable = function(fn, args, t) {
    const timeoutFunction = setTimeout(function(){fn.apply(null,args)},t);
    const cancelFn = function(){clearTimeout(timeoutFunction)};
    return cancelFn;
};
  ...
  const fn = (x) => x * 5;
  const args = [2], t = 2000, cancelTimeMs = 2500;
