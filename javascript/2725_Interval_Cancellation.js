...
The function fn should be called with args 
immediately and then called again every t 
milliseconds until cancelFn is called at cancelTimeMs ms.*/

var cancellable = function(fn, args, t) {
    const firstInterval = fn(...args);
    const intervalFunction = setInterval(function(){fn(...args)},t);
    const cancelFn = function(){clearInterval(intervalFunction)};
    return cancelFn;
};
